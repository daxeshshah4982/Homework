...
//    WebElement _verifysignup;
    @FindBy(xpath = "//ul[@class='nav navbar-nav top-main-menu']//span[contains(text(),'Shipping')]")
...
//    WebElement _hotdeals;
    ...
    WebElement _hotdeals;
    @FindBy(xpath = "//ul[@class='nav navbar-nav top-main-menu']//li[@class='leaf']//a[@href='sale-products/']")
    WebElement _sales;
...
*/
    public void mouseHoverOnShipping(){
        log.info("mousehover to shipping and wait till find the element");
        mouseHoverAndWaitForElement(_shipping);
    }
    public void mouseHoverToHotdealsAndClickOnSales() {
        log.info("mousehover to hotdeals, wait and than click on sales");
        mouseHoverAndWaitForElement(_hotdeals);
        clickOnElement(_sales);
    }
