package com.youtube.browserselector;
...
public class BrowserSelector extends BasePage {
    ...
    String baseURL = new LoadProperties().getProperties("baseurl");
    ...
    public void selectBrowser(String browser){
        if (browser.equalsIgnoreCase("chrome")){
            ...
            System.out.println("Mistake in browser name,check config.properties file");
        }
