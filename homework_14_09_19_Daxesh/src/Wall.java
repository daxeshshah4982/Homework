...
The class needs to have two constructors. The first constructor does not have any parameters (no-
arg constructor). The second constructor has parameters width and height of type double and it

needs to initialize the fields. In case the width is less than 0 it needs to set the width field value to 0,
...
public class Wall {
    ...
    public void setWidth(double widthF) {
        if (widthF < 0) {
            width = 0;
        } else {
            width = widthF;
    ...
    public void setHeight(double heightF) {
        if (heightF < 0) {
            height = 0;
        } else {
            height = heightF;
